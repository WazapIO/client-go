...
// Data
func (r ApiSendPaymentRequestRequest) Data(data PaymentRequestPayload) ApiSendPaymentRequestRequest {
	r.data = &data
	return r
}

func (r ApiSendPaymentRequestRequest) Execute() (*APIResponse, *http.Response, error) {
...
*/
func (a *BusinessManagementApiService) SendPaymentRequest(ctx context.Context, instanceKey string) ApiSendPaymentRequestRequest {
	return ApiSendPaymentRequestRequest{
		ApiService: a,
		ctx: ctx,
		instanceKey: instanceKey,
...
// Execute executes the request
//  @return APIResponse
func (a *BusinessManagementApiService) SendPaymentRequestExecute(r ApiSendPaymentRequestRequest) (*APIResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BusinessManagementApiService.SendPaymentRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instances/{instance_key}/business/payment-request"
	localVarPath = strings.Replace(localVarPath, "{"+"instance_key"+"}", url.PathEscape(parameterToString(r.instanceKey, "")), -1)
