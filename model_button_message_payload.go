...
// ButtonMessagePayload struct for ButtonMessagePayload
...
func (o ButtonMessagePayload) MarshalJSON() ([]byte, error) {
...
type NullableButtonMessagePayload struct {
	value *ButtonMessagePayload
	isSet bool
}

func (v NullableButtonMessagePayload) Get() *ButtonMessagePayload {
	return v.value
}

func (v *NullableButtonMessagePayload) Set(val *ButtonMessagePayload) {
	v.value = val
	v.isSet = true
}

func (v NullableButtonMessagePayload) IsSet() bool {
	return v.isSet
}

func (v *NullableButtonMessagePayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableButtonMessagePayload(val *ButtonMessagePayload) *NullableButtonMessagePayload {
	return &NullableButtonMessagePayload{value: val, isSet: true}
}

func (v NullableButtonMessagePayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableButtonMessagePayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
