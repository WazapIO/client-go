...
// ButtonMessageWithMediaPayload struct for ButtonMessageWithMediaPayload
type ButtonMessageWithMediaPayload struct {
	Buttons []ReplyButton `json:"buttons,omitempty"`
	FooterText *string `json:"footer_text,omitempty"`
	MediaData *FileUpload `json:"media_data,omitempty"`
...
func NewButtonMessageWithMediaPayload() *ButtonMessageWithMediaPayload {
	this := ButtonMessageWithMediaPayload{}
	return &this
}
...
// SetButtons gets a reference to the given []ReplyButton and assigns it to the Buttons field.
...
// SetMediaData gets a reference to the given FileUpload and assigns it to the MediaData field.
...
func (o ButtonMessageWithMediaPayload) MarshalJSON() ([]byte, error) {
...
type NullableButtonMessageWithMediaPayload struct {
	value *ButtonMessageWithMediaPayload
	isSet bool
}

func (v NullableButtonMessageWithMediaPayload) Get() *ButtonMessageWithMediaPayload {
	return v.value
}

func (v *NullableButtonMessageWithMediaPayload) Set(val *ButtonMessageWithMediaPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableButtonMessageWithMediaPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableButtonMessageWithMediaPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableButtonMessageWithMediaPayload(val *ButtonMessageWithMediaPayload) *NullableButtonMessageWithMediaPayload {
	return &NullableButtonMessageWithMediaPayload{value: val, isSet: true}
}

func (v NullableButtonMessageWithMediaPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableButtonMessageWithMediaPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
